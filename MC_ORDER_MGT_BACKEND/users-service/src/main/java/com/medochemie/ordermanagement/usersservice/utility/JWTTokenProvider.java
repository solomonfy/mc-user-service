...
//    // this should be stored in secured server and have it in properties file,
//    // @Value annotation tells spring to grab the value from application.yaml or application.properties file
//    @Value("${jwt.secret}")
